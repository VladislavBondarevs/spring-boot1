...
public class AdminController {
    ...
    @Autowired
    public AdminController(PasswordEncoder passwordEncoder, DutyScheduleService scheduleService,UserService userService, UserServiceImpl userServiceImpl, UserRepository userRepository,TicketService ticketService) {
